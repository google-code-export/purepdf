package
{
	...
	import org.purepdf.elements.AnnotationInt;
	import org.purepdf.elements.AnnotationString;
	...
	public class SimpleAnnotation2 extends DefaultBasicExample
	{
		...
		override protected function execute( event: Event = null ): void
		{
			...
			var a1: Annotation = new AnnotationString( "authors", "bla bla bla...." );
			a1.setDimensions( 250, 700, 350, 800 );
			
			var a2: Annotation = new AnnotationUrl( "http://www.sephiroth.it" );
			a2.setDimensions( 250, 550, 350, 650 );
			
			var a4: AnnotationInt = new AnnotationInt( PdfAction.LASTPAGE );
