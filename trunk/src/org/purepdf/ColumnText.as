package org.purepdf
{
	...
	public class ColumnText
	{
		...
		protected var indent: Number = 0;
		protected var followingIndent: Number = 0;
		protected var rightIndent: Number = 0;
		protected var extraParagraphSpace: Number = 0;
		...
		public function setLeading( leading: Number ): void
		{
		...
		public function go( simulate: Boolean = false ): int
		{
			...
			while( true )
			{
				...
				if( !simulate ) 
				{
					...
					text.setTextMatrix( 1, 0, 0, 1, x1 + ( line.isRTL ? rightIndent : firstIndent ) + line.pdf_core::indentLeft, yLine );
		 ...
		 */    
		public static function showTextAligned( canvas: PdfContentByte, alignment: int, phrase: Phrase, x: Number, y: Number, rotation: Number, runDirection: int = 0 ): void
		{
