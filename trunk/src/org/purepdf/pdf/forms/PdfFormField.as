...
package org.purepdf.pdf.forms
{
	...
	public class PdfFormField extends PdfAnnotation
	{
		...
		private static const mergeTarget: Vector.<PdfName> = Vector.<PdfName>( [PdfName.FONT, PdfName.XOBJECT, PdfName.COLORSPACE,
						PdfName.PATTERN] );
		...
		static public function createCheckBox( writer: PdfWriter ): PdfFormField
		{
			return createButton( writer, 0 );
		}

		static public function createCombo( writer: PdfWriter, edit: Boolean, options: Vector.<String>,
						topIndex: int ): PdfFormField
		{
			return createChoice( writer, FF_COMBO + ( edit ? FF_EDIT : 0 ), processOptions( options ), topIndex );
		}

		static public function createCombos( writer: PdfWriter, edit: Boolean, options: Vector.<Vector.<String>>,
						topIndex: int ): PdfFormField
		{
			return createChoice( writer, FF_COMBO + ( edit ? FF_EDIT : 0 ), processOptions2( options ), topIndex );
		}

		static public function createEmpty( writer: PdfWriter ): PdfFormField
		{
			var field: PdfFormField = new PdfFormField( writer, null );
			return field;
		}

		static public function createList( writer: PdfWriter, options: Vector.<String>, topIndex: int ): PdfFormField
		{
			return createChoice( writer, 0, processOptions( options ), topIndex );
		}

		static public function createLists( writer: PdfWriter, options: Vector.<Vector.<String>>, topIndex: int ): PdfFormField
		{
			return createChoice( writer, 0, processOptions2( options ), topIndex );
		}

		static public function createPushButton( writer: PdfWriter ): PdfFormField
		{
			return createButton( writer, FF_PUSHBUTTON );
		}

		static public function createRadioButton( writer: PdfWriter, noToggleToOff: Boolean ): PdfFormField
		{
			return createButton( writer, FF_RADIO + ( noToggleToOff ? FF_NO_TOGGLE_TO_OFF : 0 ) );
		}

		static public function createSignature( writer: PdfWriter ): PdfFormField
		{
		...
		static public function createTextField( writer: PdfWriter, multiline: Boolean, password: Boolean,
						maxLen: int ): PdfFormField
		{
			var field: PdfFormField = new PdfFormField( writer );
		...
		static public function shallowDuplicate( annot: PdfAnnotation ): PdfAnnotation
		{
		...
		static protected function createButton( writer: PdfWriter, flags: int ): PdfFormField
		{
			var field: PdfFormField = new PdfFormField( writer, null );
		...
		static protected function createChoice( writer: PdfWriter, flags: int, options: PdfArray, topIndex: int ): PdfFormField
		{
			var field: PdfFormField = new PdfFormField( writer );
		...
		static pdf_core function mergeResources( result: PdfDictionary, source: PdfDictionary ): void
		{
			mergeResources2( result, source, null );
		}

		static pdf_core function mergeResources2( result: PdfDictionary, source: PdfDictionary, writer: Object ): void
		{
		...
		static protected function processOptions( options: Vector.<String> ): PdfArray
		{
			var array: PdfArray = new PdfArray();
		...
		static protected function processOptions2( options: Vector.<Vector.<String>> ): PdfArray
		{
			var array: PdfArray = new PdfArray();
